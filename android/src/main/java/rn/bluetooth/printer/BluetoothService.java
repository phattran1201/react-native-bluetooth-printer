...
public class BluetoothService {
    ...
    private class ConnectedThread extends Thread {
        ...
        public void run() {
            ...
            for (int i = 1; i <= 3; i++) {
                try {
                    tmp = (BluetoothSocket) mmDevice.getClass().getMethod("createRfcommSocket", int.class)
                            .invoke(mmDevice, i);
                } catch (Exception e) {
                }
                if (tmp != null) {
            ...
            // keep the address of last connected device and get this address directly in
            // the .js code
        ...
        public void write(byte[] buffer) {
            try {
                ...
                mmOutStream.flush();// Flush buffer
                /*
